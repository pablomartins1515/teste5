          ...
          <div className="flex-1 ml-8">
            ...
            <div>
              <div className="text-3xl mb-4 text-gray-600">
                <strong>{data.lesson.subtext2}</strong>
              </div>
              <div className="text-lg mb-10">{data.lesson.blogtext2}</div>
            </div>
            <div className="flex items-center pl-8 pr-8">
              <div className="h-full border-l-4 border-blue-900 mr-4">
                ...
                <h1 className="text-4xl m-0 ml-4 text-gray-500">
                  <span>{data.lesson.textcenter}</span>
                </h1>
              </div>
            </div>
            <div>
              <div className="text-3xl mb-4 mt-10 text-gray-600"></div>
              <span className="text-lg mb-6">{data.lesson.blogtext3}</span>
            </div>
            <span className="mb-8">
              <Pesquisador />
            </span>
            <div>
              <div className="text-3xl mb-4 mt-12 text-gray-600">
                <strong>{data.lesson.subtext4}</strong>
              </div>
              <span className="text-lg mb-6">{data.lesson.blogtext4}</span>
            </div>
            <div>
              <div className="mt-6 text-3xl mb-4 text-gray-600">
                <strong>{data.lesson.subtext5}</strong>
              </div>
              <span className="text-lg mb-6">{data.lesson.blogtext5}</span>
            </div>
